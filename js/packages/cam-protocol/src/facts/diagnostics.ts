export type CamFactDiagnosticCode =
  ...
  | "CAM_FACT_ROUTE_EXPRESSION_SYNTAX_INVALID"
  | "CAM_FACT_ROUTE_EXPRESSION_ROOT_INVALID"
  | "CAM_FACT_ROUTE_EXPRESSION_INPUT_INVALID"
  | "CAM_FACT_ROUTE_EXPRESSION_INPUT_UNDECLARED"
  | "CAM_FACT_ROUTE_EXPRESSION_OUTPUT_UNAVAILABLE"
