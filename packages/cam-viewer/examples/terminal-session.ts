...
const CAM_URI = "file:///work/dapps/bike-nft/cam/main.json"
...
async function loadResource(uri: string): Promise<Uint8Array> {
  if (!uri.startsWith("file:///work/dapps/bike-nft/cam/")) {
    throw new Error(`resource URI is outside the mounted bike CAM: ${uri}`)
  }
...
function printHelp(): void {
  output.write("Commands: show, set <name> <value>, press <n>, route <name> [key=value ...], account <address|clear>, help, quit\n")
}
