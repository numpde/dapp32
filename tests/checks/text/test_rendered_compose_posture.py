...
class RenderedComposePostureTest(unittest.TestCase):
        ...
        self.assertEqual(
            {
                ...
                "BIKE_NFT_RELEASE_INTENDED_CAM_ROOT_OWNER": "0x0000000000000000000000000000000000000011",
                ...
                "BIKE_NFT_RELEASE_INTENDED_COMPONENTS_ADMIN": "0x0000000000000000000000000000000000000012",
                ...
                "BIKE_NFT_RELEASE_INTENDED_MANAGER_ADMIN": "0x0000000000000000000000000000000000000015",
    ...
    def test_all_rendered_ports_secrets_and_fixture_keys_are_explicitly_inventoried(self) -> None:
        ...
        expected_secrets = {
            ...
            (
                "compose/escrow/release/verify.yml",
                "escrow-release-verify-rpc-proxy",
                "rpc_url",
                "rpc_url",
            ),
        }
    ...
    def test_cam_publication_preflight_renders_as_offline_hardened_service(self) -> None:
        config = rendered_compose_config(makefile_compose_unit("CAM_PUBLICATION_PREFLIGHT_COMPOSE_FILES"))
        preflight = compose_service(config, "cam-publication-preflight")

        self.assert_hardened(preflight)
        self.assertEqual("none", preflight.get("network_mode"))
