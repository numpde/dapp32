...
class ComposePostureTest(unittest.TestCase):
    ...
    def test_node_package_workspace_stager_is_image_owned(self) -> None:
        ...
        self.assertIn("manifest.workspaces", stager_text)
        self.assertIn("supports only first-level positive workspace globs", stager_text)
    ...
    def test_package_build_test_and_viewer_targets_check_locked_graph(self) -> None:
        ...
        self.assertIn("package-graph-check:", text)
        self.assertIn("package-build-check:", text)
        self.assertNotIn("package-build-check: package-graph-check", text)
        self.assertNotIn("\npackage-build:", text)
        ...
        self.assertIn("package-test:", text)
        self.assertNotIn("package-test: package-graph-check", text)
        self.assertIn("package-ci: package-test viewer-terminal-check", text)
        self.assertIn("viewer-terminal-check:", text)
        self.assertNotIn("viewer-terminal-check: package-graph-check", text)
        self.assertIn("run --build --rm -T viewer-terminal-check", text)
        self.assertIn("viewer-terminal:", text)
        self.assertNotIn("viewer-terminal: package-graph-check", text)
